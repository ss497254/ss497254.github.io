...
export default function Icon({ size = 80 }) {
    return (
        <svg
            ...
            x="0px"
            y="0px"
            viewBox="0 0 432.49 432.49"
            width={size}
            height={size}
            // style="enable-background:new 0 0 432.49 432.49;"
        >
            <g>
                <g>
                    <path
                        style={{ fill: 'none' }}
                        d="M178.568,137.364c0,20.775,16.901,37.677,37.677,37.677s37.677-16.901,37.677-37.677
               c0-20.774-16.901-37.677-37.677-37.677S178.568,116.59,178.568,137.364z"
                    />
                    <path
                        style={{ fill: 'none' }}
                        d="M225.096,370.187c-2.273,2.482-5.484,3.895-8.851,3.895c-3.366,0-6.577-1.413-8.851-3.895
               ...
               C243.449,350.084,226.088,369.103,225.096,370.187z"
                    ...
                    <path
                        style={{ fill: '#73D0F4' }}
                        d="M95.855,144.392c0,52.005,80.011,153.768,120.39,199.706
               ...
               C154.568,103.356,182.236,75.688,216.245,75.688z"
                    ...
                    <path
                        style={{ fill: '#3D6889' }}
                        d="M405.897,345.366l-124.755-42.908c3.628-4.769,7.303-9.681,10.987-14.721
               ...
               c3.366,0,6.577-1.413,8.851-3.895c0.992-1.084,18.354-20.103,40.434-47.719l99.512,34.227L215.932,407.803z"
                    ...
                    <path
                        style={{ fill: '#3D6889' }}
                        d="M216.245,199.041c34.009,0,61.677-27.668,61.677-61.677c0-34.009-27.668-61.677-61.677-61.677
