...
export const about = {
    ...
    paragraphTwo:
        'I am a full-stack web developer and a Competitive Programmer who loves to design and develop beautiful websites. I love to learn new things and I am always open to learn new technologies.',
    paragraphThree:
...
export const projects = [
    {
        ...
        info2: `Bloggy uses Nodejs as backend and MongoDB to store data. Frontend of the app is made with React, application state is managed with react-redux and it uses ChakraUI to create beautiful and responsive components for the app.`,
        tags: ['Nodejs', 'MongoDB', 'React Js', 'Chakra UI', 'Redux'],
    ...
    },
    {
        ...
        title: 'SASA',
        info: `Implementing operating system core concepts for creating a Nodejs based web app for faster data access, more efficient handling of large number of requests.`,
        info2: `Faster data access is gained by using LRU page replacement algorithm and performance is increased by concurrently running multiple child processes to efficiently use CPU cores.`,
        tags: ['Nodejs', 'React Js', 'Clustering', 'LRU'],
